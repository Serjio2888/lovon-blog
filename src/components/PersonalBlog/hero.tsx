...
const Hero = async () => {
  const author: Author = await getAuthorBySlug("ryna-kenter");

  return (
    <section>
      <div className="mx-auto max-w-[1170px] px-4 pb-12.5 pt-34 sm:px-8 xl:px-0">
        <div className="relative z-10 overflow-hidden rounded-[20px]">
          {/* <!-- Hero BG Shapes Start --> */}
          <div>
            <div className="absolute bottom-0 left-0 h-full w-full rounded-[20px] bg-gray"></div>
            <div className="absolute bottom-0 left-0 h-full w-full rounded-[20px]">
              <Image
                className="absolute bottom-0"
                src="/images/hero/hero-bg-02.svg"
                alt="hero bg"
                width={1170}
                height={347}
              />
          ...
          {/* <!-- Hero Content Start --> */}
          <div className="relative z-1 mx-auto max-w-[880px] px-4 py-7.5 sm:px-8 sm:py-10 lg:px-0 lg:py-15">
            <div className="flex flex-col items-center gap-7.5 sm:flex-row lg:gap-15">
              ...
              <div className="w-full max-w-[593px]">
                ...
                <div className="mt-7 flex items-center gap-5">
                  <a
                    href="#"
                    className="flex hover:text-dark lg:transition-all lg:duration-300 lg:ease-linear"
                  >
                    <svg
