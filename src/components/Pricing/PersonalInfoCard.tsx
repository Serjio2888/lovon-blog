...
const PersonalInfoCard = () => {
  ...
  return (
    <div className="max-w-[520px] px-4 sm:px-8 xl:px-0">
      <div className="mb-9">
      ...
      <button
        ...
        className="mt-4 flex w-full items-center justify-center gap-2.5 rounded-lg border border-gray-4 p-3.5 text-dark duration-200 ease-in hover:border-gray-5 hover:bg-gray"
      >
        <svg
          width="22"
          height="22"
      ...
      <span className="relative mt-9 block text-center text-custom-sm">
        ...
        <span className="absolute right-0 top-1/2 block h-px w-full max-w-30 bg-gray-3"></span>
